...
class PopUpPracticeFragment(private val postDatabase: PostDatabase) : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Ketika tombol ubah diklik, intent baru dibuat untuk memulai UpdatePeopleRoomActivity dan pemain yang dipilih dikirim sebagai extra.
